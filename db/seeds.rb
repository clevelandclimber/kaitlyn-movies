...
create_movie(name: "Christmas at the Palace", year: nil, believable: nil, rating: 3, imdb: nil, poster: nil, must_see: :no, premise: nil, sort_name: "christmas at the palace", notes: "Ice Skating 3 stars")
create_movie(name: "The Christmas Calendar", year: nil, believable: nil, rating: 3, imdb: nil, poster: nil, must_see: :no, premise: nil, sort_name: "christmas calendar", notes: nil)
...
create_movie(name: "Christmas in the Smokies", year: 2015, believable: nil, rating: nil, imdb: "https://www.imdb.com/title/tt4923846", poster: nil, must_see: :no, premise: nil, sort_name: "christmas in the smokies", notes: nil)
...
create_movie(name: "Dolly Parton's Christmas on the Square", year: 2020, believable: nil, rating: nil, imdb: "https://www.imdb.com/title/tt10627548", poster: nil, must_see: :no, premise: nil, sort_name: "christmas on the square", notes: nil)
create_movie(name: "A Christmas Prince", year: 2017, believable: :makes_sense, rating: 3, imdb: "https://www.imdb.com/title/tt7608418", poster: "A Christmas Prince", must_see: :yes, premise: "A want-to-be writer is sent to Aldovia to cover a press conference. When the conference is cancelled, she snoops around the castle and is mistaken for the new tutor.", sort_name: "christmas prince", notes: "The one that started the genre for many. A fun, romantic, royal film.")
...
create_movie(name: "Christmas Wedding Planner", year: 2017, believable: nil, rating: nil, imdb: "https://www.imdb.com/title/tt7074092", poster: nil, must_see: :no, premise: nil, sort_name: "christmas wedding planner", notes: nil)
...
create_movie(name: "Falling in Love", year: 2019, believable: nil, rating: nil, imdb: "https://www.imdb.com/title/tt9860728", poster: nil, must_see: :no, premise: nil, sort_name: "falling in love", notes: nil)
...
create_starring("Falling in Love", "Adam Demos", :lead)
create_starring("Falling in Love", "Christina Milian", :lead)
