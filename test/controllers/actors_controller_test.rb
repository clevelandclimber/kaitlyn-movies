...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference("Actor.count") do
      post actors_url, params: { actor: { imdb: @actor.imdb, name: @actor.name, photo: @actor.photo } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { imdb: @actor.imdb, name: @actor.name, photo: @actor.photo } }
